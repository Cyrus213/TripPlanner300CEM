...
public class SecondActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(table == 1){
            second_title.setText(R.string.title_text);
            second_subtitle.setText(R.string.about_text);
            second_ratingbar.setRating(4.91f);
            second_rating_number.setText("4.91");
        }else if(table == 2){
            second_title.setText(R.string.title_text1);
            second_subtitle.setText(R.string.about_text1);
            second_ratingbar.setRating(4.75f);
            second_rating_number.setText("4.75");
        }else if(table == 3) {
            second_title.setText(R.string.title_text2);
            second_subtitle.setText(R.string.about_text2);
            second_ratingbar.setRating(4.75f);
            second_rating_number.setText("4.75");
        }
