...
public class Planner extends AppCompatActivity {//trip planner
    ...
    ArrayList<String> trip_id, trip_location, trip_date, trip_time;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        add_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(Planner.this, AddActivity.class);
        ...
        customAdapter = new CustomAdapter(Planner.this,this, trip_id, trip_location, trip_date,
                trip_time);
    ...
    void storeDataInArrays(){//store data in array
        ...
        if(cursor.getCount() == 0){
            ...
            while (cursor.moveToNext()){
                ...
                trip_location.add(cursor.getString(1));
                trip_date.add(cursor.getString(2));
                trip_time.add(cursor.getString(3));
            }
